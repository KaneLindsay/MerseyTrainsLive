                        ...
                        try {
                            ...
                            for (int i = 0; i < messageList.length(); i++) {
                                ...
                                if (msgType== 0003) {                                               //If message is a train movement
                                    ...
                                    messageArray[0] = body.getString("train_service_code");     //com.example.merseytrainslive.livedata.Service Code (8-digit code)
                            ...
                            Log.e("JSON ERROR", "unexpected JSON exception", e);
                        }
                    }
                });
